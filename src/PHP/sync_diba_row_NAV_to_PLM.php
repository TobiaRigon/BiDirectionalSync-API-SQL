...
require_once 'functions_Diba_row_NAV_to_PLM.php';
...
if (!empty($datiCorrotti)) {
    // Prepara i dati nel formato richiesto
    $datiPreparati = preparaDati($datiCorrotti);

    // Filtra i dati in base ai codici
    $datiFiltrati = filtraDatiPerCodici($datiPreparati, $codesS01MOD, $parent_codici, $codesS01MAT);
